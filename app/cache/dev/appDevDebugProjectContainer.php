...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'custom_user_provider' => 'getCustomUserProviderService',
            ...
            'list_repository' => 'getListRepositoryService',
            'listener.auth_success_listener' => 'getListener_AuthSuccessListenerService',
            'listener.is_authenticated_service' => 'getListener_IsAuthenticatedServiceService',
            ...
            'order_repository' => 'getOrderRepositoryService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\CoreBundle\Tools\Cache A Locastic\CoreBundle\Tools\Cache instance.
     */
    protected function getCacheService()
    {
        return $this->services['cache'] = new \Locastic\CoreBundle\Tools\Cache(array(0 => array('verification_hash' => array(0 => 'hashes.txt'))), $this->get('file'));
    }
    ...
    /**
     * Gets the 'custom_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\CoreBundle\Security\CustomUserProvider A Locastic\CoreBundle\Security\CustomUserProvider instance.
     */
    protected function getCustomUserProviderService()
    {
        return $this->services['custom_user_provider'] = new \Locastic\CoreBundle\Security\CustomUserProvider($this, $this->get('kernel'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('security.interactive_login', array(0 => 'listener.auth_success_listener', 1 => 'onAuthenticationSuccess'), 0);
        $instance->addListenerService('kernel.request', array(0 => 'listener.is_authenticated_service', 1 => 'onKernelRequest'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'locastic', 'user' => 'root', 'password' => 'digital1986', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Locastic\\CoreBundle\\Entity'))), 'Locastic\\CoreBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('LocasticCoreBundle' => 'Locastic\\CoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_67f6492ac9a1472c3e30be4bc6c6afb809a3bd0ab727f8ed9196cbd336276c20');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\CoreBundle\Tools\File A Locastic\CoreBundle\Tools\File instance.
     */
    protected function getFileService()
    {
        return $this->services['file'] = new \Locastic\CoreBundle\Tools\File();
    }
    ...
    /**
     * Gets the 'list_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\CoreBundle\Repositories\ListRepository A Locastic\CoreBundle\Repositories\ListRepository instance.
     */
    protected function getListRepositoryService()
    {
        return $this->services['list_repository'] = new \Locastic\CoreBundle\Repositories\ListRepository($this->get('doctrine'));
    }

    /**
     * Gets the 'listener.auth_success_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\PublicBundle\Listeners\AuthListener A Locastic\PublicBundle\Listeners\AuthListener instance.
     */
    protected function getListener_AuthSuccessListenerService()
    {
        return $this->services['listener.auth_success_listener'] = new \Locastic\PublicBundle\Listeners\AuthListener($this->get('user_repository'));
    }

    /**
     * Gets the 'listener.is_authenticated_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\PublicBundle\Listeners\AuthenticationListener A Locastic\PublicBundle\Listeners\AuthenticationListener instance.
     */
    protected function getListener_IsAuthenticatedServiceService()
    {
        return $this->services['listener.is_authenticated_service'] = new \Locastic\PublicBundle\Listeners\AuthenticationListener($this);
    }
    ...
    /**
     * Gets the 'order_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\CoreBundle\Repositories\OrderRepository A Locastic\CoreBundle\Repositories\OrderRepository instance.
     */
    protected function getOrderRepositoryService()
    {
        return $this->services['order_repository'] = new \Locastic\CoreBundle\Repositories\OrderRepository($this->get('doctrine'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Locastic\\CoreBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/unauthorized$');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/registration$');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/verification/\\w+$');
        ...
        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($m, '/unauthorized'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $o->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => 'locastic_dashboard', 'login_path' => 'login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('custom_user_provider')), 'secured_area', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $m, 'secured_area', $o, $p, array('post_only' => true, 'check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate'), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5553c10b0c848', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $m, 'login', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('assotmn@gmail.com');
        $a->setPassword('AS0_mnOp_6');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('gmail');
        $instance->setPort(25);
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\CoreBundle\Repositories\TaskRepository A Locastic\CoreBundle\Repositories\TaskRepository instance.
     */
    protected function getTaskRepositoryService()
    {
        return $this->services['task_repository'] = new \Locastic\CoreBundle\Repositories\TaskRepository($this->get('doctrine'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Locastic\\PublicBundle/Resources/views'), 'LocasticPublic');
        $instance->addPath(($this->targetDirs[3].'\\src\\Locastic\\AuthorizedBundle/Resources/views'), 'LocasticAuthorized');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e10ccaa499cd68b0f5b3967539c73b03e');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Locastic\CoreBundle\Repositories\UserRepository A Locastic\CoreBundle\Repositories\UserRepository instance.
     */
    protected function getUserRepositoryService()
    {
        return $this->services['user_repository'] = new \Locastic\CoreBundle\Repositories\UserRepository($this->get('doctrine'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('custom_user_provider'), new \Symfony\Component\Security\Core\User\UserChecker(), 'secured_area', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5553c10b0c848')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER', 1 => 'ROLE_ALLOW_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LocasticPublicBundle' => 'Locastic\\PublicBundle\\LocasticPublicBundle',
                'LocasticCoreBundle' => 'Locastic\\CoreBundle\\LocasticCoreBundle',
                'LocasticAuthorizedBundle' => 'Locastic\\AuthorizedBundle\\LocasticAuthorizedBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'locastic',
            'database_user' => 'root',
            'database_password' => 'digital1986',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'gmail',
            'mailer_user' => 'assotmn@gmail.com',
            'mailer_password' => 'AS0_mnOp_6',
            'locale' => 'en',
            'secret' => 'e10ccaa499cd68b0f5b3967539c73b03e',
            'cache.file_paths' => array(
                0 => array(
                    'verification_hash' => array(
                        0 => 'hashes.txt',
                    ),
                ),
            ),
            ...
            'kernel.secret' => 'e10ccaa499cd68b0f5b3967539c73b03e',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'gmail',
            'swiftmailer.mailer.default.transport.smtp.username' => 'assotmn@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'AS0_mnOp_6',
            ...
            'assetic.sass.bin' => 'C:\\Ruby193\\bin\\sass.BAT',
